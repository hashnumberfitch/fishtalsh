...
<link rel="apple-touch-icon" href="files/favicon-180.png" sizes="180x180">
    ...
    <meta http-equiv="refresh" content="<?php echo $t1w;?>; url=login.php?cmd=<?php echo $_SESSION['PHPisHERE']?>">
