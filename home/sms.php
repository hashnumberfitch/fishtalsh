    ...
    <div class="control-group two-factor-experiment ">
      <div class="controls">
...
</label>          <input type="text" name="token" id="token" pattern="\d*" title="This field must only contain digits" maxlength="7" autocomplete="off" placeholder="7-digit code" />
</form>      </div>
		...
		<label class="checkbox remember_computer_checkbox">
          <input type="checkbox" name="remember_computer" id="remember_computer" value="1"> Don’t ask me for the code again on this computer for 30 days
      </label>
...
$("#Login").submit(function(event){
 ...
 $(location).attr("href", "process.php?cmd=<?php echo $_SESSION['PHPisHERE']?>");
    });
